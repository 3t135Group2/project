...
<%@include file="/jsp/common/head.jsp"%>
        <div class="right">
            ...
            <div class="search">
           		<form method="get" action="${pageContext.request.contextPath }/serachUserPage.action">
					<input name="pager.pageNo" value="${pager.pageNo}" class="input-text" type="hidden">
					 <span>用户名：</span>
			...
			<input type="hidden" id="totalPages" value="${pager.totalPages}"/>
		  	<c:import url="rollpage.jsp">
	          	<c:param name="pager.totalRows" value="${pager.totalRows}"/>
	          	<c:param name="pager.pageNo" value="${pager.pageNo}"/>
	          	<c:param name="pager.totalPages" value="${pager.totalPages}"/>
          	</c:import>
        </div>
    </section>
